...
public class ConstantConfig {
    ...
    public static long ALLOWED_NOT_RUNNING_TIME=1800000;//设备多久不运行就休眠监控器
    ...
    public static final String DeviceCollisionMonitor_THREAD_PREFIX = "DeviceCollisionMonitor-";
    public static final String OtherMonitor_THREAD_PREFIX = "OtherMonitor-";
